...
class Controller:
    ...
    def run(self):
        ...
        self.obs[5:17]=qj_obs
        self.obs[17:29]=dqj_obs
        self.obs[29:41]=self.action#*0.5
        self.obs[41:44]=ang_vel
        self.obs[44:47]=gravity_orientation#eu_ang
        ...
        self.obs_tensor = torch.from_numpy(self.obs).unsqueeze(0)
                # policy inference
        self.action = self.policy(self.obs_tensor).detach().numpy().squeeze()
